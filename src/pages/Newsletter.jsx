              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
                <div className="col-span-12 lg:col-span-6 xl:col-span-5 max-w-[500px] flex flex-col gap-3 p-4 bg-white dark:bg-brandDarkSecondary rounded-lg shadow-sm">
                  ...
                  <div>
                    <input
                      ...
                      className="w-full px-6 py-3 dark:bg-gray-750 dark:text-gray-100 text-[16px]  border border-gray-300 dark:border-gray-600 focus:border-gray-700 dark:focus:border-gray-500 outline-none rounded-full"
                    />
                  </div>
                  <button
                    type="button"
                ...
                <div className="col-span-12 lg:col-span-6 xl:col-span-5 max-w-[500px] flex flex-col gap-3 p-4 bg-white dark:bg-brandDarkSecondary rounded-lg shadow-sm">
                  ...
                  <div>
                    <input
                      ...
                      id="newsletter2"
                      placeholder="Enter your email"
                      className="w-full px-6 py-3 dark:bg-gray-750 dark:text-gray-100 text-[16px] border border-gray-300 dark:border-gray-600 focus:border-gray-700 dark:focus:border-gray-500 outline-none rounded-[6px]"
                      />
                  </div>
                  <div>
                    <button
                ...
                <div className="col-span-12 lg:col-span-6 xl:col-span-5 max-w-[500px] flex flex-col gap-3 p-4 bg-white dark:bg-brandDarkSecondary rounded-lg shadow-sm">
                  ...
                  <div className="flex px-2">
                    <div className=" w-full flex justify-between p-[3px] dark:bg-gray-750 dark:text-gray-100 border  border-gray-300 dark:border-gray-600 hover:border-gray-700 dark:hover:border-gray-500 rounded-full"> 
                      <input
                        type="text"
                        id="newsletter3"
                        placeholder="Enter your email"
                        className="w-full px-6 py-3 dark:bg-gray-750 dark:text-gray-100 text-[14px] sm:text-[16px] rounded-full outline-none"
                      />
                      <button
                        type="button"
