...
const AdminLayout = ({children, setOpenSidebarMenu, global: {sidebarMenuOpen, sidebarMenuManualClose, darkMode}}) => {
    ...
    useEffect(() => {
     ...
     if (sidebarMenuOpen && width < 1024) {  // md responsivity width
        setOpenSidebarMenu(false, false)
     } else if (!sidebarMenuOpen && !sidebarMenuManualClose) {
      setOpenSidebarMenu(true, false)
     }
    }, [width])
  ...
  return (
    <div className="flex min-h-screen text-gray-700">
      ...
      >
        <Link
          to={"/"}
          className="flex items-center ml-[2px] py-[10px] text-[20px] text-gray-600 dark:text-gray-300"
        >
          <div>
            <img
          ...
          <div className="ml-[10px]">FastDash</div>
        </Link>
        <hr />
        <div className="py-3">
          <div className="pl-2 text-gray-500 dark:text-gray-400">APPS</div>
          <div className="w-full">
            ...
            >
              <div className="w-full flex">
                ...
                <div className="ml-3 dark:text-gray-300">Analytics</div>
              </div>
            </NavLink>
          </div>
          ...
          <div className="w-full flex items-center">
            ...
            >
              <div className="w-full flex">
                ...
                <div className="ml-3 dark:text-gray-300">Crm</div>
              </div>
            </NavLink>
          </div>
          <div className="w-full flex items-center">
            ...
            >
              <div className="w-full flex">
                ...
                <div className="ml-3 dark:text-gray-300">Kanban</div>
              </div>
            </NavLink>
          </div>
          ...
          <div className="w-full flex items-center">
            ...
            >
              <div className="w-full flex">
                ...
                <div className="ml-3 dark:text-gray-300">Profile</div>
              </div>
            </NavLink>
          </div>
          {!darkMode && (
          ...
          <div className="pl-2 mt-[6px] text-gray-500">FORMS</div>
          <div className="w-full flex items-center">
            <NavLink
              to={"/newsletter"}
              className={({ isActive }) =>
            ...
            >
              <div className="w-full flex">
                ...
                <div className="ml-3 dark:text-gray-300">Newsletter</div>
              </div>
            </NavLink>
          </div>
          <div className="w-full flex items-center">
          ...
          <div className="w-full flex items-center">
            ...
            >
              <div className="w-full flex">
                ...
                <div className="ml-3 dark:text-gray-300">Charts</div>
              </div>
            </NavLink>
          </div>
          <div className="w-full flex items-center">
          ...
          <div className="w-full flex items-center">
            ...
            >
              <div className="w-full flex">
                ...
                <div className="ml-3 dark:text-gray-300">Buttons</div>
              </div>
            </NavLink>
          </div>

          <div className="mt-[6px] pl-2 text-gray-500">AUTHENTICATION</div>
          <div className="w-full flex items-center">
            <NavLink
              to={"/sign-in"}
              className={({ isActive }) =>
            ...
            >
              <div className="w-full flex">
                ...
                <div className="ml-3 dark:text-gray-300">Sign in</div>
              </div>
            </NavLink>
          </div>
          <div className="w-full flex items-center">
            ...
            >
              <div className="w-full flex">
                ...
                <div className="ml-3 dark:text-gray-300">Sign up</div>
              </div>
            </NavLink>
          </div>
        </div>
